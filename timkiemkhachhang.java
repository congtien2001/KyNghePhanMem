...
public class timkiemkhachhang extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txtResult, javax.swing.GroupLayout.PREFERRED_SIZE, 354, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try{
            FileInputStream fileInt = new FileInputStream("./src/quanlikhachhang/QL_KhachHang/MKH_" + txtSearch.getText() + ".data");
            ObjectInputStream intput = new ObjectInputStream(fileInt);

            var maKH = intput.readObject().toString();
            String tenKH = intput.readObject().toString();
            String GT = intput.readObject().toString();
            String loaiKH = intput.readObject().toString();
            String DC = intput.readObject().toString();
            String SDT = intput.readObject().toString();
            String EMAIL = intput.readObject().toString();
            
            khachhang kh = new khachhang( maKH,tenKH, loaiKH, DC, SDT, EMAIL, loaiKH);
            
            txtResult.setText(kh.toString());
            ...
            Logger.getLogger(timkiemkhachhang.class.getName()).log(Level.SEVERE, null, ex);
        }
